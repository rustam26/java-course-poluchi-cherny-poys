...
public class ArrayListMethod2 {
    public static void main(String[] args) {
        ...
        Student st2 = new Student("Nikolay", 'm', 28, 4, 6.3);
        Student st3 = new Student("Elena", 'f', 19, 1, 7.3);
        Student st4 = new Student("Petr", 'm', 35, 2, 10.0);
        Student st5 = new Student("Mariya", 'f', 23, 3, 9.6);
        Student st6 = new Student("Mariya", 'f', 23, 3, 9.6);
